...
<body>
	...
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/jquery-ui-touch-punch/jquery.ui.touch-punch.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/jquery-appear/jquery.appear.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/bootstrap-multiselect/bootstrap-multiselect.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/jquery-easypiechart/jquery.easypiechart.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/flot/jquery.flot.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/flot-tooltip/jquery.flot.tooltip.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/flot/jquery.flot.pie.js"></script>
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/vendor/flot/jquery.flot.categories.js"></script>
	...
	<script src="${ pageContext.servletContext.contextPath }/resources/assets/javascripts/theme_preview.js"></script>
